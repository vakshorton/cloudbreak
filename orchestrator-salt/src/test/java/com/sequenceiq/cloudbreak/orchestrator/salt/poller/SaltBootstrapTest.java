...
public class SaltBootstrapTest {
    ...
    public void callTest() {
        ...
        targets.add(new Node("10.0.0.1", null, null, "master"));
        targets.add(new Node("10.0.0.2", null, null, "master"));
        targets.add(new Node("10.0.0.3", null, null, "master"));
    ...
    public void callFailTest() {
        ...
        targets.add(new Node(missingNodeIp, null, null, "master"));
