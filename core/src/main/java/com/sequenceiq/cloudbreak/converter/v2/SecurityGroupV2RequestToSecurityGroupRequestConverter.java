...
@Component
public class SecurityGroupV2RequestToSecurityGroupRequestConverter extends AbstractConversionServiceAwareConverter<SecurityGroupV2Request, SecurityGroupRequest> {
