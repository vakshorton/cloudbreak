...
@Component
public class InstanceGroupV2RequestToInstanceGroupRequestConverter extends AbstractConversionServiceAwareConverter<InstanceGroupV2Request, InstanceGroupRequest> {
