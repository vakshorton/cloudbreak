...
@Component
public class SecurityGroupV2RequestToSecurityGroupConverter extends AbstractConversionServiceAwareConverter<SecurityGroupV2Request, SecurityGroupRequest> {
