...
public class StackV2RequestToStackConverter extends AbstractConversionServiceAwareConverter<StackV2Request, Stack> {
    ...
    private void validateStackAuthentication(StackV2Request source) {
    ...
    private void validateCustomImage(StackV2Request source) {
    ...
    private String getRegion(StackV2Request source) {
    ...
    private void setPlatform(StackV2Request source) {
    ...
    private Map<String, String> getValidParameters(StackV2Request stackRequest) {
        ...
        if (userParams != null) {
            ...
            for (StackParamValidation stackParamValidation : stackParameterService.getStackParams(user, stackRequest.getName(),
                   null, stackRequest.getCredentialId(), null)) {
    ...
    private Set<InstanceGroup> convertInstanceGroups(StackV2Request source, Stack stack) {
        ...
        for (InstanceGroupV2Request instanceGroupRequest : instanceGroupRequests) {
